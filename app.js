...
async function loginUser() {
  ...
  try {
    ...
    // 🔔 Notifications (in-app) — polls backend for new updates
...
/* =================== NOTIFICATIONS (IN-APP) ===================
   ✅ Fast + safe: backend stores a small queue per email.
   📌 Note: This is polling (every ~25s). True background push can be Phase 2.
*/
